...
describe('Suppliers Management', () => {
    ...
    beforeAll(async () => {
       ...
       ON CONFLICT DO NOTHING`, [supplierId, 'Initial Supplier', '081234567890', 'supplier@test.com', 'Supplier Address', 'Net 30', true, new Date(), new Date()]);
    });
    afterAll(async () => {
        // Cleanup
    ...
    describe('PUT /api/suppliers/:id', () => {
        ...
        it('should reject duplicate supplier name during update', async () => {
         ...
         VALUES ($1, $2, $3, $4, $5)`, [newSupplierId, 'Unique Supplier Name', true, new Date(), new Date()]);
    ...
    describe('DELETE /api/suppliers/:id', () => {
        ...
        beforeAll(async () => {
            ...
            await db.query(`INSERT INTO suppliers (id, name, is_active, created_at, updated_at)
         VALUES ($1, $2, $3, $4, $5)`, [deletableSupplierId, 'Deletable Supplier', true, new Date(), new Date()]);
        });
        ...
        it('should reject supplier deletion for non-owner (kasir)', async () => {
            ...
            await db.query(`INSERT INTO suppliers (id, name, is_active, created_at, updated_at)
         VALUES ($1, $2, $3, $4, $5)`, [tempSupplierId, 'Temp Supplier', true, new Date(), new Date()]);
            const response = await request(app)
...
//# sourceMappingURL=suppliers.test.js.map