...
describe('Sync Routes - POST /api/sync/batch', () => {
    ...
    beforeAll(async () => {
        ...
        await db.query('INSERT INTO users (id, username, email, password_hash, role, store_id, is_active) VALUES ($1, $2, $3, $4, $5, $6, $7)', [testKasirId, 'testuser', 'test@test.com', passwordHash, 'KASIR', testStoreId, true]);
        // Insert test product
