...
describe('Purchase Orders Management', () => {
    ...
    beforeAll(async () => {
       ...
       ON CONFLICT DO NOTHING`, [supplierId, 'Test Supplier', true, new Date(), new Date()]);
        // Create product
        await db.query(`INSERT INTO products (id, name, category, buy_price, sell_price, stock, is_active, created_at, updated_at)
       VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)
       ON CONFLICT DO NOTHING`, [productId, 'Test Product', 'Liquid', 50000, 100000, 0, true, new Date(), new Date()]);
    });
    afterAll(async () => {
        // Cleanup
    ...
    describe('POST /api/purchase-orders', () => {
        ...
        it('should create purchase order with multiple items', async () => {
            ...
            await db.query(`INSERT INTO products (id, name, category, buy_price, sell_price, stock, is_active, created_at, updated_at)
         VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)`, [product2Id, 'Test Product 2', 'Coil', 75000, 150000, 0, true, new Date(), new Date()]);
            const response = await request(app)
                .post('/api/purchase-orders')
                .set('Authorization', `Bearer ${userToken}`)
                .send({
...
//# sourceMappingURL=purchase-orders.test.js.map