...
describe('BOP CRUD Operations', () => {
    ...
    beforeAll(async () => {
       ...
       ON CONFLICT DO NOTHING`, [bopId, testStoreId, 'Initial BOP', 'Description', '500000', today, null, new Date(), new Date()]);
    });
    afterAll(async () => {
        // Cleanup
    ...
    describe('DELETE /api/bop/:id', () => {
        ...
        beforeAll(async () => {
            ...
            const yesterdayStr = yesterday.toISOString().split('T')[0];
            await db.query(`INSERT INTO bop (id, store_id, name, description, amount, effective_from, effective_to, created_at, updated_at)
         VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)`, [deletableBopId, testStoreId, 'Deletable BOP', 'Description', '100000', yesterdayStr, yesterdayStr, new Date(), new Date()]);
        });
        ...
        it('should allow deletion of BOP with effective_to in the past', async () => {
            ...
            await db.query(`INSERT INTO bop (id, store_id, name, description, amount, effective_from, effective_to, created_at, updated_at)
         VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)`, [oldBopId, testStoreId, 'Old BOP', 'Description', '100000', twoWeeksAgoStr, twoWeeksAgoStr, new Date(), new Date()]);
            const response = await request(app)
...
//# sourceMappingURL=bop.crud.test.js.map