 ...
 */
import { hasRole, canAccessStore, getFeaturePermission, normalizePermission, PERMISSIONS, } from './permissions.js';
describe('Permission Utilities', () => {
    describe('hasRole() - Role validation', () => {
        ...
        it('should return false for null or undefined permission', () => {
            expect(hasRole('OWNER', null)).toBe(true); // 'public' check
            expect(hasRole('OWNER', undefined)).toBe(true);
        });
    });
    ...
    describe('getFeaturePermission() - Feature permission lookup', () => {
        ...
        it('should return null for invalid feature', () => {
            const permission = getFeaturePermission('INVALID', 'ACTION');
    ...
    describe('normalizePermission() - Permission normalization', () => {
        ...
        it('should return empty array for null or invalid input', () => {
            const normalized = normalizePermission(null);
    ...
    describe('Permission consistency', () => {
        it('should have consistent role names throughout', () => {
            const allPermissions = Object.values(PERMISSIONS).flatMap((feature) => Object.values(feature).flatMap((perm) => {
