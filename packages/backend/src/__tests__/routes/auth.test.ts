...
describe('Authentication Routes', () => {
  ...
  let testKasirUserId: string;
  let testOwnerUserId: string;
  let testKasirEmail: string;
  ...
  beforeAll(async () => {
    ...
    await db.query(
      ...
      [testKasirUserId, 'testkasir', testKasirEmail, hashedPassword, 'KASIR', testStoreId, true]
    );
    ...
    await db.query(
      `INSERT INTO users (id, username, email, password_hash, role, is_active) 
       VALUES ($1, $2, $3, $4, $5, $6) 
       ON CONFLICT DO NOTHING`,
      [testOwnerUserId, 'testowner', testOwnerEmail, hashedPassword, 'OWNER', true]
    );
  ...
  describe('POST /api/v1/auth/logout', () => {
    ...
    it('should handle logout gracefully if no attendance record exists', async () => {
      ...
      await db.query(
        `INSERT INTO users (id, username, email, password_hash, role, store_id, is_active) 
         VALUES ($1, $2, $3, $4, $5, $6, $7)`,
        [newKasirUserId, 'testkasir_new', newKasirEmail, hashedPassword, 'KASIR', testStoreId, true]
      );
